...
@pytest.mark.asyncio
async def test_get_all_budgets_success_flow(budget_service, mock_logger):
    # arrange

    # act
    result = await budget_service.get_all_budgets(BUDGET.user_id)
